    ...
    <div className="lds-dual-ring"></div>
            ...
            <div className="image-slider">
                <Swiper
                    ...
                    breakpoints={{
                        1024: {
                            slidesPerView: 4, // For screens 1024px and larger
                            spaceBetween: 30,
                        },
                        768: {
                            slidesPerView: 3, // For screens 768px and larger
                            spaceBetween: 20,
                        },
                        0: {
                            slidesPerView: 1, // For screens below 768px
                            spaceBetween: 10,
                        },
                    }}
                    style={{
      ...
      `}
                    ...
                    {products.map((product, index) => (
                        <SwiperSlide key={index}>
                            ...
                            >
                                <Link to={`/product/singleProduct/${product._id}`} className="image-container">
                                    <img
                                        src={product.image}
                                        alt={product.title}
                                    />
                                ...
                                <div className="card-body">
                                    ...
                                    <Link to={`/product/singleProduct/${product._id}`} className="btn btn-primary">
                                        View Details
                                    </Link>
                                </div>
                            </div>
